...
#+BEGIN_SRC R :file sim_validation.png :results value graphics
...
#+BEGIN_SRC R :file sim_validation2.png :results value graphics
...
#+BEGIN_SRC R :session :file addRemove2taxon2seg.png :results value graphics
...
#+BEGIN_SRC R :session :file addRemove5taxon2seg.png :results value graphics
...
#+BEGIN_SRC R :session :file addRemove5taxon3seg.png :results value graphics
...
#+BEGIN_SRC R :session :file addRemove5taxon8seg.png :results value graphics
...
#+BEGIN_SRC R :session :file uniform5taxon8seg.png :results value graphics
doCompare("simulate_serial5taxon8seg.log",
...
#+BEGIN_SRC R :session :file divertSeg5taxon8seg.png :results value graphics
doCompare("simulate_serial5taxon8seg.log",
...
#+BEGIN_SRC R :session :file scale5taxon8seg.png :results value graphics
doCompare("simulate_serial5taxon8seg.log",
