...
public class SIRwithReassortmentSIE extends Network implements Loggable {
...
//                segmentTreesInput.get().add( segmentTree);
    ...
    protected void simulateNetwork() {
        ...
        do {
            ...
            double I = 1;
            ArrayList<Double> timeAtInfection = new ArrayList<>();
            int individualNr = 0;
...
//                    System.out.println(probCoInf);
                    if (Randomizer.nextDouble() > probCoInf) {
                        ...
                        timeAtInfection.add(time + nextEventTime);
                    ...
                    timeAtInfection.remove(Randomizer.nextInt(timeAtInfection.size()));
                    // update the population counts
                    I--;
                    R++;
