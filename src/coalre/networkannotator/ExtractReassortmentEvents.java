 ...
 */
public class ExtractReassortmentEvents extends ReassortmentAnnotator {
    ...
    public ExtractReassortmentEvents(NetworkAnnotatorOptions options) throws IOException {
    ...
    public static void main(String[] args) {
        ...
        // Run ACGAnnotator
        try {
            new ExtractReassortmentEvents(options);
