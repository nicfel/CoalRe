...
/**
 * Specifies the interval types. Adapted by Nicola Felix Müller to allow for reassortment
 *
 * @author Andrew Rambaut
 * @author Alexei Drummond
 * @version $Id: IntervalType.java,v 1.9 2005/05/24 20:25:56 rambaut Exp $
 */
public enum NetworkIntervalType {
     ...
     * This means that the colour of one lineage changes.
     */
    REASSORTMENTSTART("reassortmentstart"),
    
    /**
     * Denotes an interval at the end of which a migration event occurs.
     * This means that the colour of one lineage changes.
     */
    REASSORTMENTEND("reassortmentend"),
     ...
     */
    private NetworkIntervalType(String name) {
        this.name = name;
    }
